...
export default {
  ...
  methods: {
    submit: function() {
      var virgule = /;/i;
      if (this.nom.match(virgule) || this.cuisine.match(virgule) || this.street.match(virgule) || this.zipCode.match(virgule))
        alert("Le caractère ';' est interdit !");
      else if (this.nom != "" && this.cuisine != "" && this.street != "" && this.zipCode != "") {
        this.$emit("inputData", this.nom + ";" + this.cuisine + ";" + this.street + ";" + this.zipCode);
        this.cuisine = "";
        this.nom = "";
        this.street = "";
        this.zipCode = "";
